    ...
    return (
        <button
            className={cn(
                ...
                `h-12 pl-5.5 pr-3 text-xl leading-none tracking-button-m md:h-20 md:pl-10 md:pr-5.25
                 md:text-6xl md:tracking-button-m 2xl:h-24 2xl:pl-10 2xl:text-7xl 2xl:tracking-button-l`,
                `relative w-full bg-transparent transition-all before:absolute before:inset-y-0 before:right-0
                 ...
                 hover:before:w-12 before:hover:bg-white md:mb-6 md:hover:before:w-25 lg:w-auto`,
                michroma.className,
                className
            )}
            type="button"
